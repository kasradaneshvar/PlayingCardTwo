...
class PlayingCardView: UIView {
    ...
    @IBInspectable // For "online" inspection of the view.
    ...
    @objc func adjustFaceCardScale(byHandlingGestureRecognizedBy recognizer: UIPinchGestureRecognizer) {
        ...
        case .changed, .ended:
            ...
            recognizer.scale = 1.0 // Reset the `scale`
        default: break
        }
    }
    ...
    override func draw(_ rect: CGRect) {
        ...
        if isFaceUp {
            if let faceCardImage = UIImage(named: rankString + suit, in: Bundle(for: self.classForCoder), compatibleWith: traitCollection) { // The stuff after `named` is for "quick preview"
